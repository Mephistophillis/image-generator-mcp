...
import { generateImageHandler } from "./tools/generate.js";
import { editImageHandler } from "./tools/edit.js";
import { listModelsHandler } from "./tools/models.js";
    ...
    tools: [
      {
        name: "generate_image",
        description:
          "Generate an image from text description using OpenRouter's Nano Banana model",
        inputSchema: {
          type: "object",
          properties: {
            prompt: {
            ...
            output_path: {
              type: "string",
              description:
                "Path to save the image file (optional, auto-generated if not provided)",
            },
            model: {
              type: "string",
              description:
                "Model to use for generation (optional, defaults to Nano Banana)",
            },
          },
          required: ["prompt"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            model: {
              type: "string",
              description:
                "Model to use for editing (optional, defaults to Nano Banana)",
            },
          },
